...
// colrs for type of card
const ccBgColor01 = document.querySelector('.cc-bg svg > g g:nth-child(1) path')
const ccBgColor02 = document.querySelector('.cc-bg svg > g g:nth-child(2) path')
const ccLogo = document.querySelector('.cc-logo  span:nth-child(2) img')

// function on set type de cards
function setCard(type){
    const colors = {
        "visa": ['#436D99', '#2D57F2'],
        "mastercard": ['#DF6F29', '#C69347'],
        "america": ['#748FF4', '#D7E6F6'],
        "default": ['back','gray'],
    }
...
const cardNumberPattern = {
    mask: [
        ...
        {
            mask: '0000 0000 0000 0000',
            regex: /(^3[1-3]\d{0,2}|^21[2-6]\d|^6[3-8]\d{0,2})\d{0,12}/ ,
            cardType: 'america',
        },
        {
            mask: '0000 0000 0000 0000',
...
expirationDateMask.on('accept', () => {
     updateExpireDate(expirationDateMask.value)
})
